...
public class Solution {
    ...
    static int queensAttack(int n, int k, int r_q, int c_q, int[][] obstacles) {
        ...
        int[] lTop = top[2] < left[2]? new int[]{r_q - top[2], c_q - top[2], top[2]}: new int[]{r_q - left[2], c_q - left[2], left[2]};
        int[] rTop = top[2] < right[2]? new int[]{r_q - top[2], c_q - top[2], top[2]}: new int[]{r_q - right[2], c_q - right[2], right[2]};
        int[] lBottom = bottom[2] < left[2]? new int[]{r_q + bottom[2], c_q + bottom[2], bottom[2]} : new int[]{r_q + left[2], c_q + left[2], left[2]};
        int[] rBottom = bottom[2] < right[2]? new int[]{r_q + bottom[2], c_q + bottom[2], bottom[2]} : new int[]{r_q + right[2], c_q + right[2], right[2]};
        ...
        if(k != 0){
            ...
            result += top[2] + right[2] + bottom[2] + left[2] +lTop[2] + rTop[2] +rBottom[2] + lBottom[2];
        }
